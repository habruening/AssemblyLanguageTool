  ...
  (testing "with incorrect page size"
    (let [[header-0 header-1 &_] (clojure.string/split-lines (slurp "test/TestData/PageHeaderTests.txt"))]
      (protocol
       ...
       (lst/page-with-correct-header? ["a" header-0 header-1 ""]) => :line-0-not-empty
       (lst/page-with-correct-header? ["" header-0 header-1 "a"]) => :line-3-not-empty
  ...
  (testing "with real example"
    (let [pages (->> "test/TestData/JCOBITCP_JCOBTCC.LIS"
                   ...
                   ; We don't expect a warning here.
                     ...
                     (mapv all-as-jstr))]
      (protocol
       (nth pages 0) => (butlast (nthrest (clojure.string/split (slurp "test/TestData/JCOBITCP_JCOBTCC_expected_page_2.LIS") #"\r?\n" -1) 3))
       (nth pages 1) => (butlast (nthrest (clojure.string/split (slurp "test/TestData/JCOBITCP_JCOBTCC_expected_page_3.LIS") #"\r?\n" -1) 3))
       (nth pages 2) => (butlast (nthrest (clojure.string/split (slurp "test/TestData/JCOBITCP_JCOBTCC_expected_page_4.LIS") #"\r?\n" -1) 3))
       (nth pages 3) => (butlast (nthrest (clojure.string/split (slurp "test/TestData/JCOBITCP_JCOBTCC_expected_page_5.LIS") #"\r?\n" -1) 3))
       (nth pages 4) => (butlast (nthrest (clojure.string/split (slurp "test/TestData/JCOBITCP_JCOBTCC_expected_page_6.LIS") #"\r?\n" -1) 3))
       (nth pages 5) => (nthrest (clojure.string/split (slurp "test/TestData/JCOBITCP_JCOBTCC_expected_page_7.LIS") #"\r?\n" -1) 3)))))
